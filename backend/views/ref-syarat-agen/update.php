...
<div class="ref-syarat-agen-form">
 ...
 switch ($syarat){
     case 3;
         $html = $form->field($model, 'hak_wajib')->widget(CKEditor::class,
          ['options' =>['rows'=>6]]);
  break;
     case 2:
         $html = $form->field($model, 'syarat_komisi')->widget(CKEditor::class,
          ['options' =>['rows'=>6]]);
         break;
     case 1:
         $html = $form->field($model, 'syarat_daftar')->widget(CKEditor::class,
       ['options' =>['rows'=>6]]);
             break;
 }
    ?>
