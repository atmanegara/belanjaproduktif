...
<div class="row row-space-10">
    ...
    <div class="col-md-4">
        <?= $form->field($modelDynamic,'tgl_awal')->label('Tanggal Awal')->textInput(['type'=>'date']) ?>
    </div>
    <div class="col-md-4">
        <?= $form->field($modelDynamic,'tgl_akhir')->label('Tanggal Akhir')->textInput(['type'=>'date']) ?>
    </div>
</div>
...
//    return true
    ...
    $.post({
          ...
          url :  "<?=Url::to(['preview-laporan-agen'])?>",
          data : {
              refagen : refagen,
              tgl_awal : tglawal,
      tgl_akhir : tglakhir
