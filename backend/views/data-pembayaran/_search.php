...
/* @var $model backend\models\DataPembayaranSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="data-pembayaran-search">
    ...
    <?php // echo $form->field($model, 'tgl_konfirmasi') ?>

    <?php // echo $form->field($model, 'filename') ?>

    <?php // echo $form->field($model, 'id_status_pembayaran') ?>

    <?php // echo $form->field($model, 'id_status_dp') ?>
