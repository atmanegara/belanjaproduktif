 ...
 */
class DataAgenSearch extends DataAgen
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['id_agen','id_kab', 'id_kelurahan', 'id_kecamatan', 'id_kecamatan_domisili','id_kab_domisili', 'id_kelurahan_domisili', 'nama_agen', 'nik', 'alamat', 'rt', 'rw', 'kode_post', 'tmpt_lahir', 'tgl_lahir', 'pekerjaan', 'no_wa', 'alamat_domisili', 'rt_domisili', 'rw_domisili','no_acak_ref'], 'safe'],
        ];
    }
...
//        ]);
        ...
        $query->andFilterWhere(['like', 'id_agen', $this->id_agen])
            ...
            ->andFilterWhere(['like', 'data_agen.nik', $this->nik])
            ->andFilterWhere(['like', 'alamat', $this->alamat])
                 ->andFilterWhere(['like', 'no_acak_ref', $this->no_acak_ref]);
